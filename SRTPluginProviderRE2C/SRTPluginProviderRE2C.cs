...
{
    public class SRTPluginProviderRE2C : IPluginProvider
    {
        private Process process;
        private GameMemoryRE2CScanner gameMemoryScanner;
        ...
        public int Startup(IPluginHostDelegates hostDelegates)
        {
            ...
            process = GetProcess();
            gameMemoryScanner = new GameMemoryRE2CScanner(process);
            return 0;
        }
        ...
        private Process GetProcess() => Process.GetProcesses().Where(a => a.ProcessName.StartsWith("bio2", StringComparison.InvariantCultureIgnoreCase)).FirstOrDefault();
    }
}
